...
//	$("pagination-ul").append("<li class = 'next-page'><a href = 'javascript:void(0)'>下一页</a></li>");
//	$("pagination-ul").append("<li class = 'last-page'><a href = '${pageContext.request.contextPath}/exam/curexam.do?currpage=${totalpage}'>末页</a></li>");
