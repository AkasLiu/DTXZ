       ...
       $(document).ready(function ()  {
            ...
            timer = setInterval(function() {
                ...
                if (timec <= 0) {
                    ...
                    $('#lasttime').text('0:0:0');
                    alert('考试结束');
                    var nowPath = "${pageContext.request.contextPath}";
                    location.href = nowPath+"/exam/historyexam.do";
                    return ;
                }
