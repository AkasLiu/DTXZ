...
<html>
	...
	<div class="container">
			<div class="breadcrumb">
				<a href="${pageContext.request.contextPath }/essay/question.do">问答</a>
				<span> > </span>
				<span>发起提问</span>
			</div>
			<form action="${pageContext.request.contextPath }/essay/handleQuiz.do" >
				<div class="ques_title">
					<label> 请将您的问题告诉我们  :</label>
					<input id="title" name="title" placeholder="请在这里概述您的问题" value="" type="text">
				</div>
				<div class="ques_content">
					<textarea class="question_content" name="content"></textarea>
